...
export const zh = {
  ...
  settingsWidthPersistentDesc: '所有会话共用同一个侧边栏宽度；拖动侧边栏宽度会同步更新默认宽度占比',
...
export const en: Record<keyof typeof zh, string> = {
  ...
  settingsWidthPersistentDesc: 'All conversations share the same sidebar width; dragging the sidebar updates the default width share',
