 ...
 */
const IGNORED = /(^|[/\\])(\.git|node_modules|dist|build|\.next|out|coverage|\.cache|\.local|\.config|\.vscode|\.idea|\.vs|\.svn|\.hg|AppData|Application Data|Local Settings|\.venv|venv|__pycache__|obj|Temp|tmp)([/\\]|$)/
  ...
  if (process.platform === 'win32') {
    ...
    return {
      onAll(listener) {
        ...
        // IGNORED list so generated directories still do not trigger refreshes.
